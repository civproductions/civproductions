        ...
        $.fn.html5lightbox = function(options) {
            ...
            inst.createMarkup = function() {
                ...
                if (inst.options.fullscreenmode) {
                    ...
                    inst.$lightbox.append("<div id='html5-close-fullscreen' style='display:block;cursor:pointer;position:absolute;top:0;right:0;margin-top:0;margin-right:0;'><img class='closelightbox' src='" + inst.options.fullscreencloseimage + "'></div>");
                ...
                $(window).scroll(function() { if (inst.options.isMobile && !inst.options.mobileresizeevent) return;
                    inst.scrollBox() });
            ...
            inst.loadThumbnail = function(src, index) { var imgLoader = new Image;
                $(imgLoader).on("load", function() { var style; if (this.width / this.height <= inst.options.thumbwidth / inst.options.thumbheight) style = "width:100%;";
            ...
            inst.showNavigation = function() {
                ...
                if (inst.options.shownavcontrol) {
                    ...
                    $(".html5-nav-showcontrol").click(function() { var winH = $(window).height(); var navH = $(".html5-nav").height(); if (inst.navvisible) { inst.navvisible = false;
                            $(".html5-nav").css({ top: winH - navH + "px", bottom: "auto" }).animate({ top: winH + "px" }, function() { $(this).css({ top: "100%", bottom: "auto" }) }) } else { inst.navvisible = true; var navH = $(".html5-nav").height();
                ...
                $(".html5-nav-thumb").hover(function() { $(this).css({ opacity: 1 });
                    $(this).css({ border: inst.options.thumbborder + "px solid " + inst.options.thumbhighlightbordercolor }) }, function() { $(this).css({ opacity: inst.options.thumbopacity });
            ...
            inst.showTitle = function(w, t, description) {
                ...
                if (inst.options.inGroup && inst.options.showplaybutton) {
                    if (inst.autosliding) {
                        ...
                        $("#html5-pause", inst.$lightbox).hide() } $("#html5-play", inst.$lightbox).click(function() { $("#html5-play", inst.$lightbox).hide();
            ...
            inst.showYoutubeVimeo = function(elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function() {
                    ...
                    if (elem[ELEM_TYPE] == 3) {
                        ...
                        href += "api=1&player_id=html5boxiframevideo" } $("#html5lightbox-video").html("<iframe style='margin:0;padding:0;border:0;' id='html5boxiframevideo' width='100%' height='100%' src='" + href + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                    inst.$elem.show();
                    inst.showData();
                    if (elem[ELEM_TYPE] == 3 && typeof YT === "object" &&
                        typeof YT.Player === "function") inst.ytplayer = new YT.Player("html5boxiframevideo", { events: { "onStateChange": function(event) { if (event.data == YT.PlayerState.ENDED) { $(window).trigger("html5lightbox.videofinished"); if (inst.autosliding) inst.gotoSlide(-1);
                                    else if (inst.options.autoclose) setTimeout(function() { inst.finish() }, inst.options.autoclosedelay) } } } });
                    ...
                    inst.resizeLightbox(dataW, dataH, true, function() {
                        ...
                        if (inst.options.autoresizecontent && inst.isSameDomain(elem[ELEM_HREF])) {
                            $("#html5lightbox-web-iframe", inst.$lightbox).data("sameorigin",
                                true);
                            $("#html5lightbox-web-iframe", inst.$lightbox).on("load", function() { $(this).data("sameoriginloaded", true);
                                inst.resizeWindow() })
                        }
                        if (inst.autosliding) { inst.slideTimeout.stop();
                            inst.slideTimeout.start() }
                    ...
                    if (inst.currentElem[ELEM_TYPE] == 7 && $("#html5lightbox-web-iframe", inst.$lightbox).length > 0 && $("#html5lightbox-web-iframe", inst.$lightbox).data("sameoriginloaded")) {
                        ...
                        if (iframe && iframe.contentWindow &&
                            ...
                            if (elemH > iframe.contentWindow.document.documentElement.offsetHeight) { elemH = iframe.contentWindow.document.documentElement.offsetHeight;
                                resizeHeight = true }
                    } else if (inst.currentElem[ELEM_TYPE] == 10 && $("#html5lightbox-div", inst.$lightbox).length > 0) { var divH = $("#html5lightbox-div", inst.$lightbox).height(); if (elemH > divH) { elemH = divH;
                            resizeHeight = true } }
                    if (resizeHeight) {
            ...
            inst.calcElemSize = function(sizeObj, keepratio) {
                ...
                if (inst.currentElem[ELEM_TYPE] ==
                    0 && keepratio) { var ratio = inst.currentElem[ELEM_ORIGINALWIDTH] / inst.currentElem[ELEM_ORIGINALHEIGHT];
                    sizeObj.h = Math.round(sizeObj.w / ratio); if (sizeObj.h > h0) { sizeObj.w = Math.round(ratio * h0);
                        ...
                        sizeObj.w = w0 } } else { if (sizeObj.h > h0) { if (keepratio) sizeObj.w = Math.round(sizeObj.w * h0 / sizeObj.h);
            ...
            inst.resizeLightbox = function(elemW, elemH, bAnimate, onFinish) {
                ...
                if (!inst.options.fullscreenmode && (!inst.options.isTouch || !inst.options.navarrowsalwaysshowontouch) && !inst.options.alwaysshownavarrows) {
                    ...
                    inst.$elem.on("mouseleave", function() { inst.$next.fadeOut();
                        inst.$prev.fadeOut() })
                }
                inst.$lightboxBox.css({ "margin-top": boxT });
                ...
                } else { var speed = bAnimate ? inst.options.resizespeed : 0; if (boxW == inst.$elemWrap.width() && boxH == inst.$elemWrap.height()) speed = 0;
                    inst.$lightboxBox.css({ "width": boxW, "height": "auto" });
            ...
            inst.gotoSlide = function(slide) {
                if (slide == -1) { if (inst.options.nextElem < 0) return;
                    ...
                    inst.options.curElem = inst.options.prevElem } else if (slide >=
            ...
            inst.embedHTML5Video = function($container, src, autoplay, loopvideo) {
                ...
                if (!inst.options.nativehtml5controls) { $("video", $container).data("src", src);
                    $("video", $container).lightboxHTML5VideoControls(inst.options.skinsfolder, inst, inst.options.videohidecontrols, false, inst.options.defaultvideovolume) } $("video", $container).off("ended").on("ended", function() {
